...
import { ChevronLeft, PieChart, Calendar, CheckCircle2 } from "lucide-react";
          ...
          <section className="bg-white border border-slate-200/80 rounded-2xl p-6 flex flex-col gap-5 shadow-xs">
            ...
            {isLoading || !currentAnalytics ? (
              ...
              <>
                ...
                <div className="grid grid-cols-4 gap-2 bg-slate-50/80 border border-slate-200/70 p-3.5 rounded-xl text-center">
                ...
                <div className="flex flex-col gap-3 pt-3">
                  ...
                  <div className="flex flex-col gap-2">
                    {currentAnalytics.categories.map((cat) => (
                      <div
                        key={cat.name}
                        className="flex items-center justify-between p-3 rounded-xl bg-slate-50/70 border border-slate-200/70 text-sm"
                      >
                        <div className="flex items-center gap-3">
                          <span className="w-3 h-3 rounded-full" style={{ backgroundColor: cat.color }} />
                          <span className="font-semibold text-slate-700 w-32 truncate">{cat.name}</span>
                        </div>
